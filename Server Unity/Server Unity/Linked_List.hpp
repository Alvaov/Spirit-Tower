...
class lista{
    ...
    public:
       ...
       */
        ...
        /**
         * @brief swap content between the 2 nodes of the list
         * @param pos1 int representing the position of the first node
         * @param pos2 int representing the position of the second node
         */
        void swap(int pos1, int pos2) {
            generic data_pos1 = get_data_by_pos(pos1);
            generic data_pos2 = get_data_by_pos(pos2);
            rewrite(data_pos1, pos2);
            rewrite(data_pos2, pos1);
        };
